...
byte data[4];
byte channels[5] = {39, 51, 83, 91, 99};
String IDS[5] = {"010909", "010921","010953","010961","010969"};
byte num = 0;
  ...
  if (t >= 1)
    { 
      ...
      if (erro == 0)
      {
        ...
        for (byte k = 0; k<4; k++){
          stringDados = stringDados + String(data[k]) + "-";
          //Serial.println(stringDados);
          }
        
        http.begin("http://172.0.0.106:8080/cgi-bin/cgi1.py?ID="+stringID+"&dados="+stringDados);
