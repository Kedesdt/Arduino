...
byte dados[10][4];
byte channels[5] = {39, 39, 39, 39, 39};
String IDS[5] = {"010909", "010909","010909","010909","010909"};
byte num = 0;
...
void verifica(int t){
  Wire.requestFrom(RDA5807M_ADDRESS,4);
    ...
    if (analogRead(34) > THRESHAUD){
      bitWrite(dados[t][3], 0, 1);
      }
    else{
      bitWrite(dados[t][3], 0, 0);
      }
    if (analogRead(35) > THRESHAUD){
