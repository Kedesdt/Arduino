...
byte channels[QUANTI] = {39};
String IDS[QUANTI] = {"010909"};
byte num = 0;
  ...
  if (t >= 10)
    { 
      ...
      if (erro == 0)
      {
        ...
        String link = "http://" + ip + ":" + porta + "/cgi-bin/cgi1.py?ID="+IDconfig;
        //String link = "http://" + ip + ":" + porta + "/sistemaradioa/receptor/servidorrxfm/cgi-bin/cgi1.py?ID="+IDconfig;

        String envioSocket = IDconfig;
