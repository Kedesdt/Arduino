...
byte channels[QUANTI] = {103, 193, 201, 209};
//byte channels[QUANTI] = {235, 187, 241, 249, 121, 15, 19};
String IDS[QUANTI] = {"010863", "010953", "010961", "010969"};
...
{
  Serial.begin(9600);
  Serial.println("VERSAO RxVariasRadiosBandaEstendida1.4");
